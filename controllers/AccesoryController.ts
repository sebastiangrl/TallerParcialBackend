...
export  async function update(req: Request, res: Response){
    const accessory: any = await AccessoryService.update(req.body.id, req.body.name, req.body.price, req.body.damage, req.body.precision, req.body.scope, req.body.cadence, req.body.mobility, req.body.control, req.body.level, req.body.type);
    res.status(200).json(accessory);
}
