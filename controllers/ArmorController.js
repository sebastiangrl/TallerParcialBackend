...
function update(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const armor = yield ArmorService_1.default.update(req.body.id, req.body.name, req.body.price, req.body.weight, req.body.mobility, req.body.protection, req.body.type_id);
        res.status(200).json(armor);
    });
}
