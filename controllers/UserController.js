...
function update(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const user = yield UserService_1.default.update(req.body.id, req.body.username, req.body.clan, req.body.password);
        res.status(200).json(user);
    });
}
...
function eliminar(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const user = yield UserService_1.default.eliminar(req.body.id);
        res.status(200).json(user);
    });
}
