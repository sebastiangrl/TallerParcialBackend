...
exports.getByType = exports.getByProtection = exports.getByPrice = exports.armors = exports.createArmors = void 0;
const ArmorService_1 = __importDefault(require("../services/ArmorService"));
function createArmors(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const armor = yield ArmorService_1.default.create(req.body.name, req.body.price, req.body.weight, req.body.mobility, req.body.protection, req.body.type);
...
function getByType(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const armor = yield ArmorService_1.default.getByType(req.body.type);
        res.status(200).json(armor);
    });
}
