...
exports.eliminar = exports.getAll = exports.modelList = exports.getByPrice = exports.create = exports.customCreate = exports.getByKills = exports.getByModel = void 0;
...
function getByKills(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const weapon = yield ArmyService_1.default.getByKills();
        res.status(200).json(weapon);
    });
}
...
function getAll(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const model = yield WeaponsService_1.default.getAll();
        res.status(200).json(model);
    });
}
